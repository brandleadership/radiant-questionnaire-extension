        ...
        def load_default_questionnaire_regions
          returning OpenStruct.new do |questionnaire|
            questionnaire.index = Radiant::AdminUI::RegionSet.new do |index|
              ...
              index.thead.concat %w{title_header language_header clone_header export_header modify_header}
              index.tbody.concat %w{title_cell language_cell clone_cell export_cell modify_cell}
